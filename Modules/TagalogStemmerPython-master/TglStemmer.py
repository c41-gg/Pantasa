...
def write_file(stemmed_info, word_root, root):
	...
	with open('Modules/TagalogStemmerPython-master/output/with_info.txt', 'w') as with_info, \
		open('Modules/TagalogStemmerPython-master/output/root_word.txt', 'w') as root_word, \
		open('Modules/TagalogStemmerPython-master/output/root_only.txt', 'w') as root_only:
...
def check_validation(token):
	with open('Modules\TagalogStemmerPython-master/validation.txt', 'r') as valid:
